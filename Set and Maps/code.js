...
const languages = ['English','English','English', ' Russian',' Russian',' Russian',' Russian',' Russian',' Russian',' Russian','English','English', 'German','German','German','German','German','German','German','German', ' Russian', 'Dutch', 'German', 'Dutch','Dutch','Dutch','Dutch','Dutch','Dutch', 'Serbian','Serbian','Serbian','Serbian','Serbian', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili', 'Swahili',  'Dutch','Dutch', 'Serbian', 'Swahili', 'Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese', 'Chinese',  'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Arabic', 'Arabic','Arabic', 'French','French','French','French','French','French','French','French','French','French','French','French','French','French','French','French','French','French','French', 'Arabic','Arabic','Arabic','Arabic','Arabic','Arabic', 'French', 'Spanish','Spanish','Spanish','Spanish','Spanish','Spanish','Spanish','Spanish','Spanish','English','English','English','English','English','English','English','English','English','English','English','English','Spanish','Spanish', 'Spanish', 'Arabic','Arabic','Arabic','Arabic','Arabic','Arabic','Arabic', 'Chinese','English','English', 'English','English','English','English', 'Chinese', 'Chinese', 'Chinese', 'Chinese', 'Chinese','Portugese','Portugese','Portugese','Portugese','Portugese','Portugese','English','English','English','English','English','English', 'English','English','English','English','English','English','English','English','English','English','English','English','English','English'];
...
for (const each of languageSet){
  const languageFilter = languages.filter((element) => element == each);
  spokenLanguage.push({languages: each, spokenTimes: languageFilter.length});
}
